...
public class ChatFormatter {
    ...
    public static Component formatChatMessage(ServerPlayer player, String message) {
        ...
        net.minecraft.network.chat.MutableComponent nameComponent = Component.literal("<" + playerName + "> ")
                .setStyle(Style.EMPTY.withHoverEvent(new HoverEvent.ShowText(
                        Component.literal("§7Click to message §e" + playerName))).withClickEvent(new ClickEvent.SuggestCommand(
                                "/msg " + playerName + " ")));
