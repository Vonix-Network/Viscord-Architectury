        ...
        for (MessageAttachment attachment : message.getAttachments()) {
            ...
            MutableComponent attachmentComp = Component.literal("[" + fileName + "]")
                    .withStyle(Style.EMPTY
                            ...
                            .withHoverEvent(new HoverEvent.ShowText( Component.literal("Click to open attachment"))));
        ...
        if (embed.getTitle().isPresent()) {
            ...
            if (embed.getUrl().isPresent()) {
                title.withStyle(style -> style
                        .withClickEvent(new ClickEvent.OpenUrl(java.net.URI.create(embed.getUrl().get().toString())))
