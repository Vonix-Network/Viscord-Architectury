...
The mod is built on [Architectury](https://github.com/architectury/architectury-api) and ships as four parallel templates that share a `common/` source tree:

| Template directory | Minecraft | Loaders |
|---|---|---|
...
- [**Building From Source**](building-from-source.md) — Gradle wrappers, the four templates, `build_menu.py` helper.
